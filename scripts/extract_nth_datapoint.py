...
def main():
    ...
    parser = argparse.ArgumentParser(description="Extract a specific row from a Parquet file.")
    parser.add_argument('file_path', type=str, help="Path to the Parquet file.")
    parser.add_argument('row_number', type=int, help="The row number to extract (0-indexed).")
